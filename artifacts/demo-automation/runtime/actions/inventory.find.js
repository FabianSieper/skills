...
var __siteAction = (() => {
  ...
  var action = {
    ...
    postcondition: "Returned SKU equals the query, or the website shows its empty state.",
    parameters: {
      sku: {
        type: "string",
    ...
    run: async (page, input) => new InventoryPage(page).search(input.sku),
